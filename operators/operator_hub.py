...
from script_auto_complete.operators.bpy_ops_parameter_operators import get_bpy_ops_parameter_operators
...
def get_text_operators(text_block):
    ...
    operators.extend(get_bpy_ops_parameter_operators(text_block))
